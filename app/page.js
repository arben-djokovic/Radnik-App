...
export default function Home() {
  return (<main>
    <section className="bg-[#F4F9FF] flex flex-col items-center justify-center text-center p-16 gap-5 min-h-[calc(100vh-64px)] md:min-h-[calc(100vh-56px)] ">
        <h1 className="text-4xl font-bold md:text-5xl">Pronađi <span className="text-blue-400">stručnjaka</span> za svaki posao</h1>
    ...
    <section className="py-16 px-5 flex flex-col gap-14 bg-[#F4F9FF] text-center">
    ...
    <section className="py-16 px-5 flex flex-col items-center gap-2 bg-whit text-center">
      ...
      <button className="max-w-[600px] w-full py-1 bg-black text-white border border-black cursor-pointer hover:bg-gray-800 rounded-md"><Link href="/registracija">Napravi nalog</Link></button>
    </section>
  </main>
  );
}
